...
const dir = path.join(__dirname, 'app', 'dashboard', 'investments');
...
fs.writeFileSync(path.join(dir, 'InvestmentsClient.tsx'), clientContent, 'utf8');
console.log('Done: investments pages created');