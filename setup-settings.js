...
const dir = path.join(__dirname, 'app', 'dashboard', 'settings');
...
fs.writeFileSync(path.join(dir, 'SettingsClient.tsx'), client, 'utf8');
console.log('Done: settings pages created');