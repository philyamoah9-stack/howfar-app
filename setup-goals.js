...
const dir = path.join(__dirname, 'app', 'dashboard', 'goals');
...
fs.writeFileSync(path.join(dir, 'GoalsClient.tsx'), clientContent, 'utf8');
console.log('Done: goals pages created');